 ...
 * @params [Number]  矩阵阶数
 * */
var disorganize = exports.disorganize = function disorganize(level) {
    var length = level * level;
    var arr = [];
    var temp = void 0;
    ...
    for (i = 0; i < length; i++) {
        var random = Math.round(Math.random() * (length - 2));
        temp = arr[random];
        arr[random] = arr[i];
        arr[i] = temp;
    }
...
var randomArr = exports.randomArr = function randomArr(length) {
    var arr = [];
    var temp = void 0;
    while (arr.length < length - 1) {
        var random = 1 + Math.round(Math.random() * (length - 2));
 ...
 * @params [Number]  矩阵阶数
 * */
var evenInverseNumber = exports.evenInverseNumber = function evenInverseNumber(level) {
    var length = level * level;
    var res = [];
    var count = 0,
        k = void 0;
     ...
     * 数据交换
     * */
    var swap = function swap(arr, lastIndex, newIndex) {
     ...
     * 检测逆序奇偶性
     * */
    var bubbleOrder = function bubbleOrder(arr) {
        var i = void 0,
            j = void 0;
     ...
     * 检测逆序奇序列变偶虚序列
     * */
    var transToEven = function transToEven(arr, index) {
    ...
    var row = Math.floor(k / level);
    switch (val) {
        case 0:
            //偶序列，偶数行,生成一个偶数行的空值位置
            if (row % 2 === 0) {
                //奇数行
                k = k + level;
            }
 ...
 * */
var getTargetState = exports.getTargetState = function getTargetState(level, index, dir) {
    var direction = {
        'left': {
            x: -1,
            y: 0
...
var pointer = exports.pointer = {
    ...
    listen: function listen(e, callback, index) {
        var type = e.type;
        ...
        if (type === 'mouseup' || type === 'touchend') {
            var _pos = this.getPos(e);
            this.position.endX = _pos.x;
            this.position.endY = _pos.y;
    ...
    getDirection: function getDirection() {
        var angx = this.position.endX - this.position.startX;
        var angy = this.position.endY - this.position.startY;
        var dir = 'none';
...
var timer = exports.timer = {
    ...
    start: function start(callback) {
        ...
        var startTime = new Date().getTime(),
            tPass = 0;
        var formatter = function formatter(t) {
            var res = t > 9 ? t : '0' + t;
            return res;
        };
...
var arrayGenerate = exports.arrayGenerate = function arrayGenerate(length) {
    var items = [];
    for (var i = 1; i < length; i++) {
        items.push(i);
    }
...
var Block = function (_React$Component) {
    ...
    function Block(props) {
        ...
        _this2.size = _this2.props.size / _this2.props.level;
        _this2.boxSize = _this2.props.size + _this2.props.level + 1;
    ...
    _createClass(Block, [{
        key: 'handleEvent',
        value: function handleEvent(dir, index) {
        ...
        value: function render() {
            ...
            var _this = this;
            var listItems = this.props.squares.map(function (t, index) {
                return _this.renderSquare(index);
            });
            var className = this.props.simple ? 'widget-block add-filter' : 'widget-block';
            var styleStr = {
            ...
            return _react2.default.createElement(
                ...
                { className: className,
                    ...
                    onMouseUp: function onMouseUp(e) {
                        _util.pointer.listen(e, _this3.handleEvent);
                    },
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement(_icon.Icons, null),
                    _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', component: _home2.default }),
                    _react2.default.createElement(_reactRouterDom.Route, { path: '/game', component: _game2.default }),
                    _react2.default.createElement(_reactRouterDom.Route, { path: '/simple', component: _simple2.default })
                )
            );
        }
    }]);
...
var _shadow = __webpack_require__(80);
...
function Status(props) {
    ...
    if (props.isSuccess) {
        return _react2.default.createElement(
            'div',
            { className: 'show-status success-status' },
            '\u6210\u529F\u4E86'
        );
    } else {
        return _react2.default.createElement(
...
var Game = function (_React$Component) {
    ...
    function Game(props) {
        ...
        _this.level = _this.props.location.query.level;
        _this.length = _this.level * _this.level;
        _this.state = {
            success: false,
            level: _this.level,
            time: '00:00:00',
            timePass: 0,
            step: 0,
            squares: (0, _util.evenInverseNumber)(_this.level),
            showShadow: false
        };
        ...
        var size = Math.min(window.innerWidth - 20, window.innerHeight);
        _this.blockSize = Math.floor(size / 60) * 60;
        return _this;
    }
    ...
    _createClass(Game, [{
        ...
        key: 'timer',
        value: function timer(offsetTime) {
            var _this2 = this;
        ...
        key: 'tick',
        value: function tick(timeStr, tPass) {
            this.setState({
                timePass: tPass,
                time: timeStr
            });
        ...
        key: 'handleClick',
        value: function handleClick(dir, index) {
            var _this3 = this;

            var squares = this.state.squares.slice();
            var newIndex = (0, _util.getTargetState)(this.level, index, dir);
            if (newIndex === index || squares[newIndex] !== 0) {
                return;
            }
            var temp = squares[index];
            squares[index] = squares[newIndex];
            squares[newIndex] = temp;
            var isSuccess = squares.every(function (t, index) {
                return t === (index + 1) % _this3.length;
            });
            if (isSuccess) {
                clearInterval(this.interId);
                this.setState({
        ...
        value: function resetClick() {
            this.setState({
                ...
                step: 0,
                level: this.level,
                squares: (0, _util.evenInverseNumber)(this.level)
            });
            this.timer(0);
        }
    }, {
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'game-box' },
                _react2.default.createElement(Status, { value: this.state.time,
    ...
    return _react2.default.createElement(
        'li',
        {
            ...
            onMouseDown: function onMouseDown(e) {
                e.preventDefault();_util.pointer.listen(e, null, value);
            },
...
function ShadowBox(props) {
    ...
    var word = '';
    if (props.isSuccess) {
        var records = jokers[props.level];
        ...
        return _react2.default.createElement(
            'div',
            { className: 'shadow-box show-success' },
            _react2.default.createElement(
                'div',
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        { to: '/' },
                        _react2.default.createElement('span', { className: 'home-button' })
                    ),
                    _react2.default.createElement(
                        _reactRouterDom.Link,
                        { to: path },
                        _react2.default.createElement('span', { className: 'more-button' })
                    ),
                    _react2.default.createElement('span', { className: 'share-button' })
                )
            )
        );
        ...
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('span', { className: 'start-button', onClick: props.startHandle }),
                    _react2.default.createElement('span', { className: 'reset-button', onClick: props.resetHandle })
                )
            )
        );
    } else {
        return _react2.default.createElement('div', { className: 'stop-button', onClick: props.pauseHandle });
    }
}
...
function Status(props) {
    var str = props.value + " x " + props.value;
    return _react2.default.createElement(
        'div',
        { className: 'nav-bar' },
        _react2.default.createElement(
        ...
        _react2.default.createElement(
            _reactRouterDom.Link,
            { to: '/' },
            _react2.default.createElement('span', { className: 'go-back' })
        )
    );
}
var translateKey = function translateKey(str) {
...
var Simple = function (_React$Component) {
    ...
    function Simple(props) {
        ...
        _this.level = +translateKey(_this.props.location.search).level;
        _this.length = _this.level * _this.level;
        _this.state = {
            level: _this.level,
            squares: (0, _util.arrayGenerate)(_this.length)
        };
        _this.handleClick = _this.handleClick.bind(_this);
        var size = Math.min(window.innerWidth - 20, window.innerHeight);
        _this.blockSize = Math.floor(size / 60) * 60;
    ...
    _createClass(Simple, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'game-box' },
                _react2.default.createElement(Status, { value: this.state.level }),
                _react2.default.createElement(_block2.default, {
                    handle: this.handleClick,
                    level: this.state.level,
                    squares: this.state.squares,
                ...
                _react2.default.createElement(
                    ...
                    { to: link },
                    ' ',
                    _react2.default.createElement('div', { className: 'start-button be-center' })
                )
            );
        }
    }]);
...
var Home = function (_React$Component) {
    ...
    _createClass(Home, [{
        key: 'selectIndex',
        value: function selectIndex(e) {
            var path = '/simple?level=' + e;
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'a',
                    { href: 'http://closertb.site/', className: 'about' },
                    _react2.default.createElement(
                        'svg',
                        null,
                        _react2.default.createElement('use', { xlinkHref: '#aboutIcon' })
                    )
                ),
                _react2.default.createElement(_picker2.default, { selectHandle: this.selectIndex, isShow: this.state.showPiker, closeHandle: this.closePicker })
            );
        }
    }]);
...
function Item(props) {
    var classItem = props.isCurry ? 'item curry' : 'item';
    return _react2.default.createElement(
        'li',
        { className: classItem },
        props.value
...
var Picker = function (_React$Component) {
    ...
    function Picker(props) {
        ...
        _this.listData = [3, 4, 5, 6, 7, 8, 9];
        _this.state = {
            top: 12, //距上边缘的距离
            index: 3 //当前选中元素
        };
        _this.maxTop = 200; //距上边缘最大移动值
        _this.eventListen = _this.eventListen.bind(_this);
        _this.handleClick = _this.handleClick.bind(_this);
    ...
    _createClass(Picker, [{
        ...
        key: 'moveDistance',
        value: function moveDistance(pointer) {
            if (!this.eve.status) {
                return;
            }
            var md = pointer.start - pointer.end,
                top = 0;
            if (Math.abs(md) < 5) {
                return;
            }
            ...
            var newIndex = this.state.index - Math.round(top / 35);
            if (newIndex < 1) {
                newIndex = 1;
            }
        ...
        value: function render() {
            ...
            var itemList = this.listData.map(function (t, index) {
                return _react2.default.createElement(Item, { value: t, isCurry: index === _this2.state.index - 1, key: t });
            });
            var styleStr = {
                transform: 'translate(0,' + (3 - this.state.index) * 35 + 'px)'
            };
            var isShowModule = this.props.isShow ? 'picker-module' : 'picker-module none';
            return _react2.default.createElement(
                'div',
                { className: isShowModule,
                    onMouseUp: function onMouseUp(e) {
                        _this2.eventListen(e);
                    },
                    onTouchEnd: function onTouchEnd(e) {
                        _this2.eventListen(e);
                    }
                },
                _react2.default.createElement('div', { className: 'piker-shadow' }),
                _react2.default.createElement(
                    'div',
                    { className: 'button-bar' },
                    _react2.default.createElement(
                        'span',
                        { className: 'btn-cancel', onClick: this.cancelClick },
                        '\u53D6\u6D88'
                    ),
                    _react2.default.createElement(
                        'span',
                    ...
                    _react2.default.createElement(
                        'span',
                        { className: 'btn-sure', onClick: this.handleClick },
                        '\u786E\u5B9A'
                    )
                ),
                _react2.default.createElement(
                    ...
                    { className: 'picker-content',
                        onMouseDown: function onMouseDown(e) {
                            e.preventDefault();_this2.eventListen(e);
                        },
                        onTouchStart: function onTouchStart(e) {
                            e.preventDefault();_this2.eventListen(e);
                        }
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('li', null),
                        _react2.default.createElement('li', { className: 'curry' }),
                        _react2.default.createElement('li', null),
                        _react2.default.createElement('li', null)
                    ),
                    _react2.default.createElement(
                        'ul',
                        { className: 'select-list', style: styleStr },
                        itemList
                    )
                )
            );
...
var Icons = exports.Icons = function Icons(props) {
    var classStyle = { 'display': 'none' };
    return _react2.default.createElement(
        'svg',
        { className: 'icon', viewBox: '0 0 1024 1024', version: '1.1', xmlns: 'http://www.w3.org/2000/svg', xmlnsXlink: 'http://www.w3.org/1999/xlink', width: '160', height: '160', style: classStyle },
        _react2.default.createElement(
            'symbol',
            { id: 'shareIcon', preserveAspectRatio: 'xMinYMin meet', viewBox: '0 0 1024 1024' },
        ...
        _react2.default.createElement(
            'symbol',
            { id: 'homeIcon', preserveAspectRatio: 'xMinYMin meet', viewBox: '0 0 1024 1024' },
            _react2.default.createElement('path', { d: 'M936.594286 603.428571q0 2.852571-0.585143 4.022857-36.571429 153.161143-153.161143 248.32t-273.115429 95.158857q-83.456 0-161.426286-31.451429t-139.117714-89.746286l-73.728 73.728q-10.825143 10.825143-25.746286 10.825143t-25.746286-10.825143-10.825143-25.746286l0-256q0-14.848 10.825143-25.746286t25.746286-10.825143l256 0q14.848 0 25.746286 10.825143t10.825143 25.746286-10.825143 25.746286l-78.262857 78.262857q40.594286 37.741714 92.013714 58.294857t106.861714 20.553143q76.580571 0 142.848-37.156571t106.276571-102.253714q6.290286-9.728 30.281143-66.852571 4.534857-13.165714 17.115429-13.165714l109.714286 0q7.460571 0 12.873143 5.412571t5.412571 12.873143zM950.857143 146.285714l0 256q0 14.848-10.825143 25.746286t-25.746286 10.825143l-256 0q-14.848 0-25.746286-10.825143t-10.825143-25.746286 10.825143-25.746286l78.848-78.848q-84.553143-78.262857-199.460571-78.262857-76.580571 0-142.848 37.156571t-106.276571 102.253714q-6.290286 9.728-30.281143 66.852571-4.534857 13.165714-17.115429 13.165714l-113.737143 0q-7.460571 0-12.873143-5.412571t-5.412571-12.873143l0-4.022857q37.156571-153.161143 154.258286-248.32t274.285714-95.158857q83.456 0 162.304 31.744t139.995429 89.453714l74.313143-73.728q10.825143-10.825143 25.746286-10.825143t25.746286 10.825143 10.825143 25.746286z' })
        ),
        _react2.default.createElement(
